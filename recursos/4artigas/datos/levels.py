...
LEVEL3 = [
        ...
        [],
[
    (_('Río Uruguay'), _('Queda en el límite\ncon Argentina')),
    (_('Río Cuareim'), _('Queda en el límite\ncon Brasil')),
    (_('Río Arapey'), _('Queda en el límite\ncon Salto')),
    (_('Arroyo Itacumbú'), _('Desemboca en el\nRío Uruguay')),
    (_('Arroyo Ñaquiña'), _('Desemboca en el\nRío Uruguay')),
    (_('Arroyo Mandiyú'), _('Desemboca en el\nRío Uruguay')),
    (_('Arroyo Guaviyú'), _('Desemboca en el\nRío Uruguay')),
    (_('Arroyo Palma Sola Grande'), _('Queda al suroeste')),
    (_('Arroyo Sarandí'), _('Queda al suroeste')),
    (_('Arroyo Yucutuya'), _('Desemboca en el\nRío Cuareim')),
    ...
    (_('Arroyo Tres Cruces Grande'), _('Desemboca en el\nRío Cuareim')),
    ...
    (_('Arroyo de la Invernada'), _('Está en el límite\ncon Brasil')),
    (_('Arroyo Sepultura'), _("It's in the east")),
    (_('Arroyo Yacuy'), _('Está en el límite\ncon Salto')),
