...
[
    ...
    (_('the city of %s') % _('Juanicó'), 2, _('Juanicó'), _("It's to the south\nof the capital")),
    ...
    (_('the city of %s') % _('Las Piedras'), 2, _('Las Piedras'), _("It is near %s") % _('Montevideo')),
    ...
    (_('the resort of %s') % _('San Luis'), 2, _('San Luis'), _("It's a resort")),
...
[
    ...
    (_('where is the only\nJewish cemetery in Uruguay'), 2, _('La Paz'), _("It's on the border\nwith %s") % _('Montevideo')),
    (_('one of the main\nsites for winemaking'), 2, _('Santa Rosa'), _("It's in the center")),
    (_('this city was named\nfor the interim\npresident of Uruguay\nfrom 1843 to 1852'), 2, _('Suárez'), _("It is near %s") % _('Pando')),
    (_('where Hernandarias\nnoted the "great abundance\nand fertility of this land"'), 2, _('Los Cerrillos'), _("It's in the west")),
    (_('a place that has had\ncountless exponents of\nmusic and art'), 2, _('San Bautista'), _("It's in the %s") % _('center-north')),
    (_('a city whose name\nmeans the existence of\na sense of improvement\nin the human condition'), 2, _('Progreso'), _("It is near %s") % _('Montevideo')),
    (_('where there is an\n8 meter high monument\nto the independence of\nthe Republic'), 2, _('Migues'), _("It's in the east")),
    ...
    (_('an important commercial\nand industrial center\nof the department'), 2, _('Pando'), _("It is near %s") % _('Montevideo'))
]
]
...
[
    ...
    (_('where is the Autodrome\nVictor Borrat Fabini'), 2, _('El Pinar'), _("Location of the first\ntoll to the East")),
    (_('a resort that welcomes\nyou with a bow\non the route'), 2, _('Salinas'), _("It is near %s") % _('Atlántida')),
    (_('one of the most popular\nresorts with tourists'), 2, _('Atlántida'), _('It is on a peninsula')),
    ...
    (_('where there is a\nfishing village'), 2, _('San Luis'), _('It is named for a saint')),
    ...
    (_('where Arabian horses\nrun in international rallies'), 2, _('Bello Horizonte'), _("It is near %s") % _('La Floresta')),
    (_('where rodeos are\nheld during Easter Week'), 2, _('Parque Roosevelt'), _("It's on the border\nwith %s") % _('Montevideo'))
]
]
...
[
    ...
    (_('Arroyo Pando'), _('Flows into the %s') % _('Río de la Plata')),
    (_('Arroyo Solís Chico'), _('Flows into the %s') % _('Río de la Plata')),
...
LEVEL5 = [
        ...
        ['capitales', 'ciudades'],
[
    (_('Route %s') % 5, _('Passes through %s') % _('Canelones')),
    (_('Route %s') % 6, _('Passes through %s') % _('Sauce')),
    (_('Route %s') % 7, _('Passes through %s') % _('San Jacinto')),
    (_('Route %s') % 8, _('Passes through %s') % _('Pando')),
