...
STATES = [
    (_('Artigas'), 254, 392, 166, 0),
    (_('Salto'), 253, 373, 375, 0),
    (_('Paysandú'), 240, 305, 742, 0),
    (_('Rivera'), 251, 756, 381, -90),
    (_('Tacuarembó'), 250, 726, 660, -90),
    (_('Argentina'), 248, 49, 141, 90),
    (_('Brasil'), 247, 689, 76, -45)
]

CITIES = [
    (_('Salto'), 78, 468, 1, 5, 14),
    (_('Belén'), 145, 225, 2, 20, 14),
    (_('Constitución'), 123, 336, 2, 45, -14),
    (_('Palomas'), 198, 340, 2, -29, 12),
    (_('Colonia Lavalleja'), 436, 340, 2, -75, 0),
    (_('Saucedo'), 219, 349, 2, 25, 14),
    (_('Masoller'), 738, 341, 2, -40, 0),
    (_('Cayetano'), 486, 388, 2, 0, 14),
    (_('Biassini'), 361, 413, 2, 20, -14),
    (_('Rincón de Valentín'), 334, 416, 2, -60, 14),
    (_('Celeste'), 378, 428, 2, 10, 14),
    (_('San Antonio'), 148, 454, 2, 56, 0),
    (_('Albisu'), 109, 467, 2, 28, 5),
    (_('Laureles'), 226, 504, 2, 0, 14),
    (_('Puntas de Valentín'), 358, 494, 2, 0, -14),
    (_('Cerros de Vera'), 458, 546, 2, 0, -14),
    (_('Paso del Parque'), 382, 611, 2, 30, -14),
    (_('Arerunguá'), 538, 579, 2, 0, -14),
    (_('Termas del Arapey'), 234, 284, 2, 30, -14),
    (_('Olivera'), 483, 346, 2, 0, 14),
    (_('Pepe Nuñez'), 603, 480, 2, 0, 14),
    (_('Mataojo'), 621, 375, 2, 0, 14)
]
...
CUCHILLAS = [
    (_('Cuchilla de los Arapeyes'), 254, 443, 338, 0),
    (_('Cuchilla del Daymán'), 253, 318, 510, -55),
    (_('Cuchilla de Haedo'), 252, 680, 436, 60)
]
...
ROUTES = [
    (_('Route %s') % 3, 250, 164, 393, 85),
    (_('Route %s') % 31, 249, 525, 475, -35),
    (_('Route %s') % 4, 248, 417, 373, 45),
    (_('Route %s') % 30, 247, 728, 300, -45)
]
