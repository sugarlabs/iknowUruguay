...
STATES = [
    (_('Durazno'), 254, 291, 119, 0),
    (_('Florida'), 253, 431, 406, 0),
    (_('Canelones'), 252, 281, 861, 0),
    (_('Lavalleja'), 251, 642, 720, 0),
    (_('San José'), 250, 27, 715, 90),
    (_('Flores'), 249, 23, 457, 90),
    (_('Treinta y Tres'), 248, 761, 133, -90)
]

CITIES = [
    (_('Florida'), 176, 642, 1, 0, 14),
    (_('Cerro Chato'), 720, 68, 2, -50, -14),
    (_('Valentines'), 730, 160, 2, -50, 0),
    (_('Capilla del Sauce'), 470, 275, 2, 0, -14),
    (_('Nico Pérez'), 697, 289, 2, -20, -14),
    (_('Illescas'), 613, 367, 2, 0, -14),
    (_('Cerro Colorado'), 517, 513, 2, 0, -14),
    (_('San Gabriel'), 346, 609, 2, 20, -14),
    (_('Reboledo'), 461, 599, 2, 43, 0),
    (_('Casupá'), 467, 658, 2, 0, -14),
    (_('Fray Marcos'), 422, 711, 2, 0, -14),
    (_('Chamizo'), 348, 744, 2, 0, -14),
    (_('Goñi'), 76, 312, 2, 0, 14),
    (_('Puntas de Maciel'), 100, 369, 2, 10, -14),
    (_('Sarandí Grande'), 107, 435, 2, 10, -14),
    (_('Pintado'), 133, 500, 2, 0, -14),
    (_('La Cruz'), 160, 560, 2, -30, -14),
    (_('La Macana'), 182, 621, 2, 0, -14),
    (_('Berrondo'), 146, 687, 2, 43, 0),
    (_('25 de Mayo'), 117, 713, 2, 51, 0),
    (_('Mendoza Chico'), 178, 742, 2, -35, 12),
    (_('Mendoza Grande'), 187, 783, 2, 50, 12),
    (_('Cardal'), 92, 775, 2, 32, 0),
    (_('Independencia'), 88, 810, 2, 65, -5)
]
...
CUCHILLAS = [
    (_('Cuchilla Mansavillagra'), 254, 420, 361, -45),
...
ROUTES = [
    (_('Route %s') % 5, 250, 182, 571, -80),
    (_('Route %s') % 6, 249, 359, 434, 75),
    (_('Route %s') % 7, 248, 555, 427, 45),
    (_('Route %s') % 42, 247, 211, 359, -85),
    (_('Route %s') % 77, 246, 100, 700, -90),
    (_('Route %s') % 56, 245, 257, 632, 20),
    (_('Route %s') % 41, 244, 486, 412, 80),
    (_('Route %s') % 14, 243, 593, 250, -30)
]
