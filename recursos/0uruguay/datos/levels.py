...
[
    ...
    (_('Río Arapey Grande'), _('Flows in the Uruguay')),
    (_('Río Cebollatí'), _('Flows in the Merin Lagoon')),
    (_('Río Cuareim'), _('Is north')),
    (_('Río Daymán'), _('Flows in the Uruguay')),
    ...
    (_('Río Queguay'), _('Flows in the Uruguay')),
    ...
    (_('Río Tacuarí'), _('Flows in the Merin Lagoon')),
